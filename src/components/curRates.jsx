...
function everything () { //function that is called when refresh data button is clicked 
   ...
   setInterval(disableButton,300000);
    ...
    if(rateInfo!==null){ //checking that object are not null 
    ...
    <div>
        ...
        <p class="a"> This information was updated at {rateInfo.time.updated}</p>
        <p class="b">The local time is {newDate}</p>
        <p class="x"> ⌄</p>

        <p class="c"> The conversion rate of {rateInfo.bpi.USD.code} ($) to BTC is {btcConversionUSD}</p>
        <p class="c"> 1 BTC to {rateInfo.bpi.USD.code} is ${rateInfo.bpi.USD.rate_float}</p>
        <p class="x"> ⌄</p>

        <p class="d"> The conversion rate of {rateInfo.bpi.EUR.code} (€) to BTC is {btcConversionEUR}</p>
        <p class="d"> 1 BTC to {rateInfo.bpi.EUR.code} is €{rateInfo.bpi.EUR.rate_float}</p>
        <p class="x"> ⌄</p>
        <p class="e"> The conversion rate of {rateInfo.bpi.GBP.code} (£) to BTC is {btcConversionGBP}</p>
        <p class="e"> 1 BTC to {rateInfo.bpi.GBP.code} is £{rateInfo.bpi.GBP.rate_float}</p>
